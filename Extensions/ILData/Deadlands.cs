...
{
    public class Deadlands : SplitGroup
    {
        public Deadlands(List<Split> splits) : base(splits) { }

        public override void SetupData()
        {
            offset = TimeSpan.Parse("00:01:05.360");
            ilType = IL.Deadlands;
            startMap = MainManager.Maps.GiantLairEntrance;
            startPos = new Vector3(55, 0, 16);
            ...
            flags = new List<int>
            {
                ...
                447,448,479,482,536,537,538,539,540,541,542,545,548,551,554,561,563,564,565,567,568,569,579,582,583,584,589,606,621,622,642,617,657,660,663,691,694,
                699,697,708,
            };
        ...
        public override void SetSplits()
        {
            ...
            {
                new Split("Deadlands 1", MainManager.Maps.GiantLairDeadLands1, TypeSplit.Room),
                new Split("Deadlands 2", MainManager.Maps.GiantLairDeadLands2, TypeSplit.Room,endID: MainManager.Maps.GiantLairFridgeOutside),
            };
        }
    }
}
