...
{
    public class Ahoneynation : SplitGroup
    {
        public Ahoneynation(List<Split> splits) : base(splits) { }

        public override void SetupData()
        {
            startSplit = TypeSplit.BattleEnd;
            ilType = IL.Ahoneynation;
            ...
            flags = new List<int>
            {
                ...
                212,213,214,215,216,217,240,278,287,307,479,482,579,617,618,621,660,663,691,694,699
            };
        ...
        public override void SetSplits()
        {
            ...
            {
                new Split("Malbee Room", MainManager.Maps.FactoryProcessingMalbee, TypeSplit.Room, enemies:abomihoneys),
                new Split("BS Room", MainManager.Maps.FactoryProcessingFirstRoom, TypeSplit.Room),
                new Split("Lobby", MainManager.Maps.HoneyFactoryEntrance, TypeSplit.Room),
                ...
                new Split("Ahoneynation", MainManager.Maps.FactoryStorageMiniboss, TypeSplit.BattleEnd, enemies: ahoneynation, endID: MainManager.Maps.FactoryProcessingMalbee)
            };
        }
    }
}
