...
{
    public class Fridge : SplitGroup
    {
        public Fridge(List<Split> splits) : base(splits) { }

        public override void SetupData()
        {
            offset = TimeSpan.Parse("00:00:15.700");
            ilType = IL.Fridge;
            startMap = MainManager.Maps.GiantLairFridgeOutside;
            startPos = new Vector3(40, 0, 18);
        ...
        public override void SetSplits()
        {
            ...
            {
                new Split("Fridge", MainManager.Maps.GiantLairFridgeInside, TypeSplit.Room,endID: MainManager.Maps.GiantLairRoachVillage)
            };
        }
    }
}
