...
{
    public class Oven : SplitGroup
    {
        public Oven(List<Split> splits) : base(splits) { }

        public override void SetupData()
        {
            ilType = IL.Oven;
            startMap = MainManager.Maps.GiantLairFridgeInside;
            startPos = new Vector3(-9, 41.6f, -1);
            items = new List<int>{130,130,172};
            ...
            flags = new List<int>
            {
                ...
                ,304,306,307,322,323,334,335,336,337,345,346,347,348,350,357,359,360,363,364,365,366,367,368,369,370,371,372,374,376,377,379,383,384,385,386,409,415,416,420,
                447,448,479,482,536,537,538,539,540,541,542,545,548,551,554,561,563,564,565,567,568,569,579,582,583,584,589,593,606,621,622,642,617,657,660,663,691,694,
                699,697,708,
            };
        ...
        public override void SetSplits()
        {
            ...
            {
                new Split("Roach Village", MainManager.Maps.GiantLairRoachVillage, TypeSplit.Room),
                new Split("Oven", MainManager.Maps.GiantLairBeforeBoss, TypeSplit.Room),
                new Split("Ice Puzzle", MainManager.Maps.GiantLairBeforeBoss2, TypeSplit.Room),
                new Split("Oven 2", MainManager.Maps.GiantLairBeforeBoss, TypeSplit.Room,endID: MainManager.Maps.GiantLairSaplingPlains)
            };
        }
    }
}
